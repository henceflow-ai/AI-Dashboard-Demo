      ...
      <div className="flex flex-col w-64">
        <div className="flex flex-col flex-1 min-h-0 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            {/* Logo */}
            <div className="flex items-center flex-shrink-0 px-4 mb-8" data-testid="sidebar-logo">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
                  <Bot className="text-white h-4 w-4" />
                </div>
                <div>
                  <h1 className="text-xl font-bold text-slate-900 dark:text-white">AI Dashboard</h1>
                  <p className="text-xs text-slate-500 dark:text-slate-400">Sales Automation</p>
                </div>
              </div>
            </div>
          ...
          {/* User Profile */}
          <div className="flex-shrink-0 flex border-t border-slate-200 dark:border-slate-700 p-4" data-testid="sidebar-user-profile">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-slate-700 dark:text-slate-200">Business Owner</p>
